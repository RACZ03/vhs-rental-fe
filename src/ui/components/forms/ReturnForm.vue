  ...
  <DialogRoot>
    ...
    <DialogPortal>
      ...
      >
        ...
        >
          Añada o Edite una devolucion aquí. Haga clic en guardar cuando haya
          terminado.
        </DialogDescription>
        <fieldset class="mb-[15px] flex items-center gap-5">
          ...
          >
            ...
            <option value="">Pelicula 2</option>
            <option value="">Pelicula 3</option>
          </select>
        </fieldset>
        <fieldset class="mb-[15px] flex items-center gap-5">
          <label
